<div x-show="showLogin === 'login' " x-cloak>
                    ...
                    <div x-data="LoginForm()">
                        <form class="flex flex-col gap-5"  @submit.prevent="submitForm" >
                            ...
                            <div class="input-component grid gap-2">
                                ...
                                <p x-show="showError && (!formData.password || formData.password.length < 12 || formData.password.length > 14)" class="text-red-500 text-sm mt-1">{{ __('auth.error-password-required') }}</p>
                            </div>
                            ...
                            <div class="component-b-text flex justify-between text-[10px] lg:text-[15px] poppins-regular">
                                ...
                                :disabled="!isFormValid()"  ><span>{{ __('auth.text-button-1') }}</span></button>
