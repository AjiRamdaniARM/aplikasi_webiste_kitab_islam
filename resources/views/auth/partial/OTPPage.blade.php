        ...
        <div class="body-two-component w-full h-full">
            <div class="bg-white rounded-[24px] lg:rounded-[60px]">
                <div class="body-c flex flex-col justify-center items-center gap-10 lg:p-20 py-20 px-10">
                    ...
                    <div class="text-c">
                        <h1 class="text-center poppins-semibold lg:text-[36px] text-[20px]">Lupa Password</h1>
                    </div>
                    <form class="flex flex-col gap-5">
                        <div class="input-component">
                            <input type="email" class="border-2 border-[#848996] rounded-[16px] lg:rounded-[24px] p-5 lg:w-[474px] lg:px-10 lg:py-5 poppins-regular" placeholder="Masukkan Email">
                        </div>
                        <div class="button-component">
                            <button type="submit" class="bg-[#E67E4D] w-full rounded-[16px] p-5 poppins-semibold hover:bg-[#D16C3DFF]">Reset Password</button>
                        </div>
                        <div class="component-b-text flex justify-between text-[10px] lg:text-[15px] poppins-regular">
                            <a href="#"><span>Gunakan OTP</span></a>
