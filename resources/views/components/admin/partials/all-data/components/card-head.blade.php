<div class="container-card">
    <div class="bg-[#FFB76B] rounded-[24px] p-10">
        <div class="content-body lg:w-96 w-full flex flex-col gap-4">
                <h1 class="uppercase text-white poppins-medium">Manager data website</h1>
                <h2 class="text-white poppins-bold text-[28px]">Ciptakan Konten Website Kitab <span class="underline">{{ $contentKitab->islamiKitab->name_kitabs }}</span>  </h2>
