<div class="container-card-profile">
    <div class="bg-[#FFFFFFFF] rounded-[24px] lg:p-10 px-5">
        ...
        <div class="content-profile mt-10 px-3">
            <img class="border-4  mx-auto w-44 sm:w-48 md:w-56 lg:w-64 xl:w-64 border-[#FFB76B] rounded-full" src="{{ asset('admin/profile/profile_contoh.jpg')}}" alt="profile">
            <div class="content-text text-center mt-10">
                <h1 class="poppins-semibold text-sm sm:text-sm md:text-md lg:text-lg xl:text-xl">GoodMorningAdmin😎</h1>
